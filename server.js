...
async function go(){
    let client= new MongoClient('mongodb+srv://todoappuser:babji420%40@cluster0.lthol.mongodb.net/todoapp?retryWrites=true&w=majority')
...
app.post('/create-item', function(req,res){
    // console.log("make this dynamic in a min from now")
